...
class Calender:
    ...
    def refresh(self, draw_black):
        ...
        draw_black.text((20, 190),self.month_cal , font = self.fonts.cal, fill = 255) # Month calender text
        draw_black.text((x_day_str,10),self.weekday_name, font = self.fonts.day_str, fill = 255) # Day string calender text
        draw_black.text((x_day_num,35),self.day_of_the_month, font = self.fonts.day, fill = 255) # Day number string text
        draw_black.text((x_month_str,150), self.month_cal, font = self.fonts.month_str, fill = 255) # Month string text
